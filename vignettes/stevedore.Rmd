...
```
## [1] "2ffbbc17c9ea961a917f06a03c41722015e87433e5acd070b8b12a80e4f88125"
```
...
##                                                                 id
## 1 2ffbbc17c9ea961a917f06a03c41722015e87433e5acd070b8b12a80e4f88125
## 2 514fa290cc50755eb5dfc9abd237d2fd690d392ceb0105fba136b217d3e4bebf
##          names
## 1 hello-st....
## 2 friendly....
##                                                                     image
...
## 1  /hello 1522783238 characte....      NA           NA        created
## 2  /hello 1522783236 characte....      NA           NA         exited
...
```
## $containers_deleted
## [1] "514fa290cc50755eb5dfc9abd237d2fd690d392ceb0105fba136b217d3e4bebf"
## [2] "ee6f37ceeb133e20cf0c24fac4f03bedbab656dd254332d2596d091288ec61ee"
## [3] "dd4d9e5b0d8537cd2391b5e124a6cdaf35dfc948c61a10371ff7727f5464c0e9"
## [4] "ad277559e3bf53356a331de22913835d856e07b7b2b090a81247b3e55bf858a8"
## [5] "690fe38356978ba656c4c7b23b86f8f9809a53f010b8ee187327bfae0789fe19"
##
## $space_reclaimed
## [1] 0
```
...
```
## [1] "c7ef7f8c4d9d5fdac4e20c43d7af5cbfbbd9c58363fca26933b7534fcfbff832"
```
...
##
## $created
## [1] "2018-04-03T19:20:38.549770189Z"
##
## $path
...
## $graph_driver$data
##                                                                                                                                                                                                                                                                                           lower_dir
## "/var/lib/docker/overlay2/9f68d3989e1584a377808af1c1714eeab03974b543afde77d8cd736008928c09-init/diff:/var/lib/docker/overlay2/7646442d3bb8e3a876c8b6fb7934cbe4ce7bb0f77945a71ffe2096a56c0452bb/diff:/var/lib/docker/overlay2/230714ad111869ebfb07688b547b1b23992cac8971b6a40f79b1753eb07335c2/diff"
##                                                                                                                                                                                                                                                                                          merged_dir
##                                                                                                                                                                                                  "/var/lib/docker/overlay2/9f68d3989e1584a377808af1c1714eeab03974b543afde77d8cd736008928c09/merged"
##                                                                                                                                                                                                                                                                                           upper_dir
##                                                                                                                                                                                                    "/var/lib/docker/overlay2/9f68d3989e1584a377808af1c1714eeab03974b543afde77d8cd736008928c09/diff"
##                                                                                                                                                                                                                                                                                            work_dir
##                                                                                                                                                                                                    "/var/lib/docker/overlay2/9f68d3989e1584a377808af1c1714eeab03974b543afde77d8cd736008928c09/work"
##
##
## $size_rw
## [1] NA
...
## 1 29581 root 0:00 {iterate} /bin/sh /usr/local/bin/iterate 1000 1
## 2 29610 root 0:00                                         sleep 1
```
...
```
## Error: No such container: c7ef7f8c4d9d5fdac4e20c43d7af5cbfbbd9c58363fca26933b7534fcfbff832
```
...
## [3] "Date: Tue, 03 Apr 2018 19:20:46 GMT"
...
## f691ab0a0436: Downloading 32.77 kB/2.71 MB 1%
## Download complete 3d7d3f4179eb
## f691ab0a0436: Downloading 97.39 kB/2.71 MB 4%
## f691ab0a0436: Downloading 153.54 kB/2.71 MB 6%
## f691ab0a0436: Downloading 219.82 kB/2.71 MB 8%
## f691ab0a0436: Downloading 281.71 kB/2.71 MB 10%
## f691ab0a0436: Downloading 347.25 kB/2.71 MB 13%
## f691ab0a0436: Downloading 412.79 kB/2.71 MB 15%
## f691ab0a0436: Downloading 478.32 kB/2.71 MB 18%
## f691ab0a0436: Downloading 534.47 kB/2.71 MB 20%
## f691ab0a0436: Downloading 595.91 kB/2.71 MB 22%
## f691ab0a0436: Downloading 665.54 kB/2.71 MB 25%
## f691ab0a0436: Downloading 728.18 kB/2.71 MB 27%
## f691ab0a0436: Downloading 788.42 kB/2.71 MB 29%
## f691ab0a0436: Downloading 859.25 kB/2.71 MB 32%
## f691ab0a0436: Downloading 924.79 kB/2.71 MB 34%
## f691ab0a0436: Downloading 980.93 kB/2.71 MB 36%
## f691ab0a0436: Downloading 1.04 MB/2.71 MB 38%
## f691ab0a0436: Downloading 1.1 MB/2.71 MB 41%
## f691ab0a0436: Downloading 1.15 MB/2.71 MB 42%
## f691ab0a0436: Downloading 1.21 MB/2.71 MB 45%
## f691ab0a0436: Downloading 1.28 MB/2.71 MB 47%
## f691ab0a0436: Downloading 1.34 MB/2.71 MB 49%
## f691ab0a0436: Downloading 1.41 MB/2.71 MB 52%
## f691ab0a0436: Downloading 1.47 MB/2.71 MB 54%
## f691ab0a0436: Downloading 1.54 MB/2.71 MB 57%
## f691ab0a0436: Downloading 1.6 MB/2.71 MB 59%
## f691ab0a0436: Downloading 1.67 MB/2.71 MB 62%
## f691ab0a0436: Downloading 1.74 MB/2.71 MB 64%
## f691ab0a0436: Downloading 1.8 MB/2.71 MB 66%
...
## f691ab0a0436: Downloading 2.25 MB/2.71 MB 83%
## f691ab0a0436: Downloading 2.31 MB/2.71 MB 85%
## f691ab0a0436: Downloading 2.38 MB/2.71 MB 88%
## f691ab0a0436: Downloading 2.45 MB/2.71 MB 90%
## f691ab0a0436: Downloading 2.51 MB/2.71 MB 93%
## f691ab0a0436: Downloading 2.58 MB/2.71 MB 95%
## f691ab0a0436: Downloading 2.64 MB/2.71 MB 97%
## f691ab0a0436: Downloading 2.71 MB/2.71 MB 100%
## Verifying Checksum f691ab0a0436
## Download complete f691ab0a0436
## f691ab0a0436: Extracting 32.77 kB/2.71 MB 1%
## f691ab0a0436: Extracting 1.67 MB/2.71 MB 62%
## f691ab0a0436: Extracting 2.62 MB/2.71 MB 97%
...
##  ---> Running in 56e8f6f19bb0
## Removing intermediate container 56e8f6f19bb0
##  ---> ee4cabc17e2e
## Step 4/5 : LABEL stevedore_version 0.0.1
##  ---> Running in a969dce0538a
## Removing intermediate container a969dce0538a
##  ---> 0f477fb05633
## Step 5/5 : ENTRYPOINT ["/usr/local/bin/iterate"]
##  ---> Running in 76d6fe7ecbcb
## Removing intermediate container 76d6fe7ecbcb
##  ---> 97fa0070b326
## Successfully built 97fa0070b326
...
```
## [1] "sha256:97fa0070b3260df7b7db2ad4e8e9c34301bb6cd2c31b4f2460682dcc89b2cf53"
```
...
##
## $parent
## [1] "sha256:0f477fb05633562d6b8d7b6c273a73230906752ac0d8a648f57c2bbc81469aa0"
##
## $comment
## [1] ""
##
## $created
## [1] "2018-04-03T19:20:57.746210189Z"
##
## $container
## [1] "76d6fe7ecbcb741c409fb8c44ceb0b6bce9eb3c50c3cae980d8c8b7e7dff59f6"
##
## $container_config
...
## $graph_driver$data
##                                                                                          lower_dir
##   "/var/lib/docker/overlay2/230714ad111869ebfb07688b547b1b23992cac8971b6a40f79b1753eb07335c2/diff"
##                                                                                         merged_dir
## "/var/lib/docker/overlay2/61780fa86151d6e53f445668c93cb985f489d885d23f48b8dba4a657e1860b64/merged"
##                                                                                          upper_dir
##   "/var/lib/docker/overlay2/61780fa86151d6e53f445668c93cb985f489d885d23f48b8dba4a657e1860b64/diff"
##                                                                                           work_dir
##   "/var/lib/docker/overlay2/61780fa86151d6e53f445668c93cb985f489d885d23f48b8dba4a657e1860b64/work"
##
##
## $root_fs
## $root_fs$type
...
## [2] "sha256:94dcfa9c9f4b075feb98a6e6ba07353acde1b73281ac15178ecd692a22af0ff7"
##
## $root_fs$base_layer
## [1] NA
```
...
##                                                                        id
## 1 sha256:97fa0070b3260df7b7db2ad4e8e9c34301bb6cd2c31b4f2460682dcc89b2cf53
## 2 sha256:0f477fb05633562d6b8d7b6c273a73230906752ac0d8a648f57c2bbc81469aa0
## 3 sha256:ee4cabc17e2e432306f460622a008e4f3a448a16458375d55923f2f0165ed34a
## 4 sha256:8b5deacdc0815a35fe078db22449e13470b1a5acbbd1ca710f9df68c43a702c0
...
##                                                                   deleted
## 1                                                                    <NA>
## 2 sha256:97fa0070b3260df7b7db2ad4e8e9c34301bb6cd2c31b4f2460682dcc89b2cf53
## 3 sha256:0f477fb05633562d6b8d7b6c273a73230906752ac0d8a648f57c2bbc81469aa0
## 4 sha256:ee4cabc17e2e432306f460622a008e4f3a448a16458375d55923f2f0165ed34a
## 5 sha256:8b5deacdc0815a35fe078db22449e13470b1a5acbbd1ca710f9df68c43a702c0
## 6 sha256:a8f517e021879b21281b5cb5c405dca9cec71616da11a020914e24c0b57f7702
```
...
##                                                               name driver
## 1                                                         myvolume  local
## 2 3dd372c14014ea37354d29a064e7405329c310d77f7f0a1de9e82c9904ff0206  local
##                                                                                       mountpoint
## 1                                                         /var/lib/docker/volumes/myvolume/_data
## 2 /var/lib/docker/volumes/3dd372c14014ea37354d29a064e7405329c310d77f7f0a1de9e82c9904ff0206/_data
...
##   $container:
##     <docker_container>
##       id: 60a58c88ddda98656dbb57eaddced8db3f82e99dffa59359f0b3457f71caeb5c
##       name: kind_bose
##
##   $logs:
##
...
## 5            host
##                                                                 id
## 1 53432b92e4394b0e1401d2b8c4d2f2b06f0f0439b51264a190b3cae6a78a78d0
## 2 9bad2ae5c810c2d3fb9e2c73db5b733338189010b3e19803003051758a3962ba
## 3 6d165f6c016347f9af798b37a0b9adfadca3e2e28ddd76e3e63de8181b04fda8
## 4 7b020165859564dd2d90207d7e2a5c26ee10afe499d095b7da1b7004bbcf8129
## 5 2f80d37c9c534b35f1dfff0896f5391243432ad720dc6df371279dfb78fea0a3
##                          created scope driver enable_ipv6         ipam
## 1 2018-04-03T17:56:23.729617738Z local bridge       FALSE default,....
## 2           0001-01-01T00:00:00Z local   null       FALSE default,....
## 3 2018-04-03T18:15:21.428857001Z local bridge       FALSE default,....
## 4 2018-04-03T19:21:02.404376089Z local bridge       FALSE default,....
## 5           0001-01-01T00:00:00Z local   host       FALSE default,....
##   internal attachable ingress containers      options labels
## 1    FALSE      FALSE   FALSE            true, tr....
## 2    FALSE      FALSE   FALSE
## 3    FALSE      FALSE   FALSE            false, t....
## 4    FALSE      FALSE   FALSE
## 5    FALSE      FALSE   FALSE
```
...
```
## [1] "7b020165859564dd2d90207d7e2a5c26ee10afe499d095b7da1b7004bbcf8129"
```
...
##
## $created
## [1] "2018-04-03T19:21:02.404376089Z"
##
## $scope
## [1] "local"
##
...
## O> 64 bytes from 172.19.0.2: seq=0 ttl=64 time=0.097 ms
## O> 64 bytes from 172.19.0.2: seq=1 ttl=64 time=0.138 ms
## O> 64 bytes from 172.19.0.2: seq=2 ttl=64 time=0.136 ms
## O>
## O> --- server ping statistics ---
## O> 3 packets transmitted, 3 packets received, 0% packet loss
## O> round-trip min/avg/max = 0.097/0.123/0.138 ms
```
...
##   $container:
##     <docker_container>
##       id: f290e2d430ca887d6fff2e1132e531b9ea51ead8dbd30c0064684a4fba67bfb7
##       name: adoring_varahamihira
##
##   $logs:
##     O> PING server (172.19.0.2): 56 data bytes
##     O> 64 bytes from 172.19.0.2: seq=0 ttl=64 time=0.097 ms
...
##
## $build_time
## [1] "2018-03-21T23:14:32.000000000+00:00"
```
...
##
## $http_proxy
## [1] "docker.for.mac.http.internal:3128"
##
## $https_proxy
## [1] "docker.for.mac.http.internal:3129"
##
## $id
## [1] "52RU:FXND:DPVM:VXXI:LZRR:6S22:F6IF:DAY2:XWLE:F6EF:O4C5:D65T"
##
## $ipv4_forwarding
## [1] TRUE
##
...
##
## $system_time
## [1] "2018-04-03T19:21:10.595131689Z"
##
## $server_version
## [1] "18.03.0-ce"
```
