...
```
## [1] "6a7a2ea6b9c1254159337ab773b4329b725a6850c61c26e6b83e2a4ff858c9cc"
```
...
##                                                                 id
## 1 6a7a2ea6b9c1254159337ab773b4329b725a6850c61c26e6b83e2a4ff858c9cc
## 2 01c3bac87189574733c34c4831ed9a373bae1bc4d6800a9ba628efe9ef5e0dbc
##          names
## 1 hello-st....
## 2 reverent....
##                                                                     image
...
## 1  /hello 1522162606 characte....      NA           NA        created
## 2  /hello 1522162605 characte....      NA           NA         exited
...
```
## $containers_deleted
## [1] "01c3bac87189574733c34c4831ed9a373bae1bc4d6800a9ba628efe9ef5e0dbc"
## [2] "d92a318e22371e32982064ea00bd15118b0303a018251df9a27d8cba32da457e"
## [3] "dc9b3bb43d268433fb461cec8aac0be7275efa3569137c97d8557af7998113dd"
##
## $space_reclaimed
## [1] 0
```
...
```
## [1] "9483b1acc56875ec96069f3caa725a629347f3ee6fab715aca9c07636f8b5eb1"
```
...
##
## $created
## [1] "2018-03-27T14:56:47.39473625Z"
##
## $path
...
##
## $image
## [1] "sha256:85a7d17164f909eef1d5a783e943ee56e78b36d0338560bfd3b64a20977bb638"
##
## $resolv_conf_path
## [1] ""
##
...
## 1 root 28014 27998 0 15:56   ? 00:00:00
## 2 root 28072 28014 0 15:56   ? 00:00:00
##                                     CMD
...
```
## Error: No such container: 9483b1acc56875ec96069f3caa725a629347f3ee6fab715aca9c07636f8b5eb1
```
...
mapped to the port 32796 on the
...
## [3] "Date: Tue, 27 Mar 2018 14:56:55 GMT"
...
## 3d7d3f4179eb: Downloading 342 B/342 B 100%
## Download complete 3d7d3f4179eb
## f691ab0a0436: Downloading 32.26 kB/2.71 MB 1%
## Verifying Checksum f691ab0a0436
## Download complete f691ab0a0436
## f691ab0a0436: Extracting 32.77 kB/2.71 MB 1%
## f691ab0a0436: Extracting 2.1 MB/2.71 MB 77%
## f691ab0a0436: Extracting 2.69 MB/2.71 MB 99%
...
##  ---> Running in 483ba68e8bb7
## Removing intermediate container 483ba68e8bb7
##  ---> c4644c0466dc
## Step 4/5 : LABEL stevedore_version 0.0.1
##  ---> Running in 6edbf88b3db6
## Removing intermediate container 6edbf88b3db6
##  ---> 497f4b320c4d
## Step 5/5 : ENTRYPOINT ["/usr/local/bin/iterate"]
##  ---> Running in 6b38904e2edd
## Removing intermediate container 6b38904e2edd
##  ---> 49a5265c7e41
## Successfully built 49a5265c7e41
...
```
## [1] "sha256:49a5265c7e419c57f7067cf2beedb9208357c521f23d8d7f104f5a3d8587d65d"
```
...
##
## $parent
## [1] "sha256:497f4b320c4d610745863168d57d5c385eefa0abf5eb228eac1a263aa4f48e24"
##
## $comment
## [1] ""
##
## $created
## [1] "2018-03-27T14:57:02.406039235Z"
##
## $container
## [1] "6b38904e2edddfb436700b0f2f7908978471e631fcd235e491ce3ea24ab57937"
##
## $container_config
...
## [2] "sha256:d30aef0309ec502f06f34ec4ac8afaef2533a59b358ae4392128d94bd3c8eea0"
##
## $root_fs$base_layer
## [1] NA
```
...
##                                                                        id
## 1 sha256:49a5265c7e419c57f7067cf2beedb9208357c521f23d8d7f104f5a3d8587d65d
## 2 sha256:497f4b320c4d610745863168d57d5c385eefa0abf5eb228eac1a263aa4f48e24
## 3 sha256:c4644c0466dca1bc14fe762cd43da41a93b95ee4db09ef617e1c01e1dc7e9250
## 4 sha256:0a5b4fc20d5f8d6eebc3eb906c0d43f235a96d68bd49ce0a86130def9dcef76f
...
## 4 /bin/sh -c #(nop) COPY file:48e845139b353a323e08aed200010b96c73e554c88abd4670b00fe70a435e118 in /usr/local/bin/iterate
...
##                                                                   deleted
## 1                                                                    <NA>
## 2 sha256:49a5265c7e419c57f7067cf2beedb9208357c521f23d8d7f104f5a3d8587d65d
## 3 sha256:497f4b320c4d610745863168d57d5c385eefa0abf5eb228eac1a263aa4f48e24
## 4 sha256:c4644c0466dca1bc14fe762cd43da41a93b95ee4db09ef617e1c01e1dc7e9250
## 5 sha256:0a5b4fc20d5f8d6eebc3eb906c0d43f235a96d68bd49ce0a86130def9dcef76f
## 6 sha256:40f4f22adea7c816b90f6621efa68f9d030e71e1cc8c16754f592806519b8c53
```
...
```
##                                                               name driver
## 1 9efdefa9e449a8e0017db7511c9c9037835bce82ddfd9377b2e0ba0757532282  local
## 2 5d616ec8e42c24b71453e67034229dea75159da085afeeef9dd66c64ba0d11f6  local
## 3                                                         myvolume  local
##                                                                                                          mountpoint
## 1 /mnt/storage/docker/var-lib-docker/volumes/9efdefa9e449a8e0017db7511c9c9037835bce82ddfd9377b2e0ba0757532282/_data
## 2 /mnt/storage/docker/var-lib-docker/volumes/5d616ec8e42c24b71453e67034229dea75159da085afeeef9dd66c64ba0d11f6/_data
## 3                                                         /mnt/storage/docker/var-lib-docker/volumes/myvolume/_data
...
##
## $mountpoint
## [1] "/mnt/storage/docker/var-lib-docker/volumes/myvolume/_data"
##
## $status
## NULL
##
...
##   $container:
##     <docker_container>
##       id: 1374e25962591190a4ff5123b62b651a794b54fe62b59253f84ac70a45e5f381
##       name: trusting_noyce
##
##   $logs:
##
...
## 4      none
##                                                                 id
## 1 a34e6459727a52ee280df6337bb63b3262747badd7cf513a67177a9798a41d1c
## 2 ef4b0161bbee83fe9d00026f59f17e7b2ef4e0f36d39f52d8fc7273cd028d3c9
## 3 f0c49515017ddeaca44d16a26df000440d5f6d114194a403964d606c3f85e3d9
## 4 9795a906cd0202f91ccbb24bbc8af582047d4d04de010445bd486cf59afdf723
##                               created scope driver enable_ipv6
## 1      2018-03-06T14:47:18.431897526Z local bridge       FALSE
## 2                0001-01-01T00:00:00Z local   host       FALSE
## 3 2018-03-27T15:57:09.995155394+01:00 local bridge       FALSE
## 4                0001-01-01T00:00:00Z local   null       FALSE
##           ipam internal attachable ingress containers      options labels
## 1 default,....    FALSE      FALSE   FALSE            true, tr....
...
```
## [1] "f0c49515017ddeaca44d16a26df000440d5f6d114194a403964d606c3f85e3d9"
```
...
##
## $created
## [1] "2018-03-27T15:57:09.995155394+01:00"
##
## $scope
## [1] "local"
##
...
## O> 64 bytes from 172.18.0.2: seq=0 ttl=64 time=0.076 ms
## O> 64 bytes from 172.18.0.2: seq=1 ttl=64 time=0.048 ms
## O> 64 bytes from 172.18.0.2: seq=2 ttl=64 time=0.072 ms
## O>
## O> --- server ping statistics ---
## O> 3 packets transmitted, 3 packets received, 0% packet loss
## O> round-trip min/avg/max = 0.048/0.065/0.076 ms
```
...
##   $container:
##     <docker_container>
##       id: 228ae6ea5a14596d7b659d3161bd36bc7c1f298a67b1376c8db1513a5d5afbb3
##       name: dazzling_lamport
##
##   $logs:
##     O> PING server (172.18.0.2): 56 data bytes
##     O> 64 bytes from 172.18.0.2: seq=0 ttl=64 time=0.076 ms
...
##
## $build_time
## [1] "2017-12-27T20:09:53.000000000+00:00"
```
...
##
## $docker_root_dir
## [1] "/mnt/storage/docker/var-lib-docker"
##
## $driver
## [1] "aufs"
##
...
## $driver_status[[1]]
## [1] "Root Dir"
## [2] "/mnt/storage/docker/var-lib-docker/aufs"
##
## $driver_status[[2]]
...
##
## $id
## [1] "374S:M5MM:BJHL:OJV7:PUWB:IWQN:CTWA:2RC7:6WKQ:RNTK:U5CZ:PN4B"
##
## $ipv4_forwarding
## [1] TRUE
##
...
##
## $system_time
## [1] "2018-03-27T15:57:26.26286749+01:00"
##
## $server_version
## [1] "17.12.0-ce"
```
