...
```
## [1] "ef72133fcfa804043fe08fa1b4ebd069426445351a4a7dfb8da241dd7f6b685b"
```
...
##                                                                 id
## 1 ef72133fcfa804043fe08fa1b4ebd069426445351a4a7dfb8da241dd7f6b685b
## 2 7c57b7824f1cba9370c2ff61e25d1dc64a40d8e6d1edf77bd6acbcb044941a76
##          names
## 1 hello-st....
## 2 optimist....
##                                                                     image
...
## 1  /hello 1522758376 characte....      NA           NA        created
## 2  /hello 1522758375 characte....      NA           NA         exited
...
```
## $containers_deleted
## [1] "7c57b7824f1cba9370c2ff61e25d1dc64a40d8e6d1edf77bd6acbcb044941a76"
## [2] "852f4d0350a7d991636282fb906f95340641fba4cde4c305190299484627e62e"
##
## $space_reclaimed
## [1] 0
```
...
```
## [1] "f281bd7c65c43fd448d9904db11f60a95c527bc46fb117bb0a20ddd518700566"
```
...
##
## $created
## [1] "2018-04-03T12:26:17.1409989Z"
##
## $path
...
## $graph_driver$data
##                                                                                                                                                                                                                                                                                           lower_dir
## "/var/lib/docker/overlay2/2bcbd3cdd934c53b2249740e5cf5649308e8064b5a8a900b746f8e1c48a24f4c-init/diff:/var/lib/docker/overlay2/4e53c7db0d3b7ba9557ef2d9ccb48ec85751857f64af8566708a03cc3bc4f3bf/diff:/var/lib/docker/overlay2/230714ad111869ebfb07688b547b1b23992cac8971b6a40f79b1753eb07335c2/diff"
##                                                                                                                                                                                                                                                                                          merged_dir
##                                                                                                                                                                                                  "/var/lib/docker/overlay2/2bcbd3cdd934c53b2249740e5cf5649308e8064b5a8a900b746f8e1c48a24f4c/merged"
##                                                                                                                                                                                                                                                                                           upper_dir
##                                                                                                                                                                                                    "/var/lib/docker/overlay2/2bcbd3cdd934c53b2249740e5cf5649308e8064b5a8a900b746f8e1c48a24f4c/diff"
##                                                                                                                                                                                                                                                                                            work_dir
##                                                                                                                                                                                                    "/var/lib/docker/overlay2/2bcbd3cdd934c53b2249740e5cf5649308e8064b5a8a900b746f8e1c48a24f4c/work"
##
##
## $size_rw
## [1] NA
...
## 1 15378    0 0:00 {iterate} /bin/sh /usr/local/bin/iterate 1000 1
## 2 15405    0 0:00                                         sleep 1
```
...
```
## Error: No such container: f281bd7c65c43fd448d9904db11f60a95c527bc46fb117bb0a20ddd518700566
```
...
## [3] "Date: Tue, 03 Apr 2018 12:26:25 GMT"
...
## f691ab0a0436: Downloading 33.37 kB/2.71 MB 1%
## f691ab0a0436: Downloading 100.07 kB/2.71 MB 4%
## f691ab0a0436: Downloading 170.56 kB/2.71 MB 6%
## f691ab0a0436: Downloading 241.24 kB/2.71 MB 9%
## f691ab0a0436: Downloading 311.89 kB/2.71 MB 11%
## f691ab0a0436: Downloading 415.88 kB/2.71 MB 15%
## f691ab0a0436: Downloading 573.01 kB/2.71 MB 21%
## f691ab0a0436: Downloading 712.28 kB/2.71 MB 26%
## f691ab0a0436: Downloading 922.2 kB/2.71 MB 34%
## f691ab0a0436: Downloading 1.15 MB/2.71 MB 42%
## f691ab0a0436: Downloading 1.51 MB/2.71 MB 56%
## f691ab0a0436: Downloading 1.97 MB/2.71 MB 72%
## f691ab0a0436: Downloading 2.57 MB/2.71 MB 95%
...
## f691ab0a0436: Extracting 786.43 kB/2.71 MB 29%
...
##  ---> Running in 9cccb03f4d1a
## Removing intermediate container 9cccb03f4d1a
##  ---> 3e588ff3f010
## Step 4/5 : LABEL stevedore_version 0.0.1
##  ---> Running in 3e1dbfdca02e
## Removing intermediate container 3e1dbfdca02e
##  ---> 44517ce15bc2
## Step 5/5 : ENTRYPOINT ["/usr/local/bin/iterate"]
##  ---> Running in 7d8cb6716303
## Removing intermediate container 7d8cb6716303
##  ---> 4fb64bb79bb1
## Successfully built 4fb64bb79bb1
...
```
## [1] "sha256:4fb64bb79bb19b040cb9aeb1034686810c0a19bd5c6cb136d3b88f0286138a73"
```
...
##
## $parent
## [1] "sha256:44517ce15bc2b3afd5570c7cdf8dff936bbc95fbf45a47f601c074267b461418"
##
## $comment
## [1] ""
##
## $created
## [1] "2018-04-03T12:26:34.3423669Z"
##
## $container
## [1] "7d8cb67163030229b784a7789176405d1626efe60c5d7037f7693cc6fbfe81ab"
##
## $container_config
...
##                                                                                         merged_dir
## "/var/lib/docker/overlay2/e4db5a335008cae122e92827529850b9c4b20c7affc22008e67d86441bce61f7/merged"
##                                                                                          upper_dir
##   "/var/lib/docker/overlay2/e4db5a335008cae122e92827529850b9c4b20c7affc22008e67d86441bce61f7/diff"
##                                                                                           work_dir
##   "/var/lib/docker/overlay2/e4db5a335008cae122e92827529850b9c4b20c7affc22008e67d86441bce61f7/work"
##
##
## $root_fs
## $root_fs$type
...
## [2] "sha256:e1fb9f7b70879a80d2f4c61c61dc9cbe599df7773981af3ad04ba97d8b764d8e"
##
## $root_fs$base_layer
## [1] NA
```
...
##                                                                        id
## 1 sha256:4fb64bb79bb19b040cb9aeb1034686810c0a19bd5c6cb136d3b88f0286138a73
## 2 sha256:44517ce15bc2b3afd5570c7cdf8dff936bbc95fbf45a47f601c074267b461418
## 3 sha256:3e588ff3f0100a2aed50256978e32baaa80cb633e97d0e1b448856e128f15074
## 4 sha256:348b1c928665253038431a34cbf8fa9a32ec1dce5f71f5e5bfaff88b4cb29037
...
##                                                                   deleted
## 1                                                                    <NA>
## 2 sha256:4fb64bb79bb19b040cb9aeb1034686810c0a19bd5c6cb136d3b88f0286138a73
## 3 sha256:44517ce15bc2b3afd5570c7cdf8dff936bbc95fbf45a47f601c074267b461418
## 4 sha256:3e588ff3f0100a2aed50256978e32baaa80cb633e97d0e1b448856e128f15074
## 5 sha256:348b1c928665253038431a34cbf8fa9a32ec1dce5f71f5e5bfaff88b4cb29037
## 6 sha256:f4fa4ff40eadb2d6a893da24a0bc45bda2b1e65a42470b49965c3ff3b794a545
```
...
```
##                                                               name driver
## 1 ab9f7b0af0c80e15657b643b5840505d3b225dddfa5621fc3ab6921dbd637941  local
## 2                                                         myvolume  local
## 3 852d3f996efa24472005406db967292df5e43ae1e0c35eb5cf4d9ee5ea02afb9  local
##                                                                                       mountpoint
## 1 /var/lib/docker/volumes/ab9f7b0af0c80e15657b643b5840505d3b225dddfa5621fc3ab6921dbd637941/_data
## 2                                                         /var/lib/docker/volumes/myvolume/_data
## 3 /var/lib/docker/volumes/852d3f996efa24472005406db967292df5e43ae1e0c35eb5cf4d9ee5ea02afb9/_data
...
##   $container:
##     <docker_container>
##       id: ed14609cedd0ba0a7e10385edf5932a280bfef39fa40da72d0fb9f4c89d399b7
##       name: jolly_lumiere
##
##   $logs:
##
...
## 5            none
##                                                                 id
## 1 55d47d534f579a6a74bd2b4990c008711520a0d8eda8e08ad18c793a7d6c4b5f
## 2 84aa11a0f6ab3124874aa105deb41ce61960911eb000d5e936e12630a66e623c
## 3 13b7bf3c9f73ae89582f2c9023447be00423aebc52f785c8cd9c8ba8c1f8363c
## 4 2f80d37c9c534b35f1dfff0896f5391243432ad720dc6df371279dfb78fea0a3
## 5 9bad2ae5c810c2d3fb9e2c73db5b733338189010b3e19803003051758a3962ba
##                         created scope driver enable_ipv6         ipam
## 1  2018-04-03T12:26:39.2179764Z local bridge       FALSE default,....
## 2 2018-03-27T11:14:01.58076974Z local bridge       FALSE default,....
## 3  2018-04-03T12:22:22.6752018Z local bridge       FALSE default,....
## 4          0001-01-01T00:00:00Z local   host       FALSE default,....
## 5          0001-01-01T00:00:00Z local   null       FALSE default,....
...
##
## $created
## [1] "2018-04-03T12:26:39.2179764Z"
##
## $scope
## [1] "local"
##
...
## O> 64 bytes from 172.19.0.2: seq=0 ttl=64 time=0.110 ms
## O> 64 bytes from 172.19.0.2: seq=1 ttl=64 time=0.159 ms
## O> 64 bytes from 172.19.0.2: seq=2 ttl=64 time=0.159 ms
## O>
## O> --- server ping statistics ---
## O> 3 packets transmitted, 3 packets received, 0% packet loss
## O> round-trip min/avg/max = 0.110/0.142/0.159 ms
```
...
##   $container:
##     <docker_container>
##       id: c9ffc888b156a7fe09744e6d695454d7e988e4b00e0244eecc220346ec2838da
##       name: happy_meitner
##
##   $logs:
##     O> PING server (172.19.0.2): 56 data bytes
...
##
## $kernel_version
## [1] "4.9.75-linuxkit-aufs"
##
## $experimental
## [1] TRUE
##
## $build_time
## [1] "2018-02-07T21:20:15.000000000+00:00"
```
...
##
## $id
## [1] "RB26:3XPC:MGQL:HN5P:3RCD:OB5S:ABKG:SZDI:KHTT:A6CQ:2CG3:Z3E4"
##
## $ipv4_forwarding
## [1] TRUE
##
...
##
## $system_time
## [1] "2018-04-03T12:26:47.6387942Z"
##
## $server_version
## [1] "18.02.0-ce"
```
