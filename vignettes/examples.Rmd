...
We now have a redis server running on 32788
...
```
## E> Cloning into '/tmp/tmp.SQDEr88uZE'...
## O> * checking for file ‘/tmp/tmp.SQDEr88uZE/DESCRIPTION’ ... OK
## O> * preparing ‘ids’:
...
## E>
## O> ────────────────────────────────────────────────────────────────────────────────
## O> ─  using log directory ‘/tmp/RtmpWDp5UT/file3d1ccf4aa2/ids.Rcheck’
