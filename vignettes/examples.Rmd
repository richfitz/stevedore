...
We now have a redis server running on 32781
...
```
## E> Cloning into '/tmp/tmp.3P092s8lrR'...
## O> * checking for file ‘/tmp/tmp.3P092s8lrR/DESCRIPTION’ ... OK
## O> * preparing ‘ids’:
...
## E>
## O> ────────────────────────────────────────────────────────────────────────────────
## O> ─  using log directory ‘/tmp/RtmpDzmFcE/file3e3a8742bc/ids.Rcheck’
