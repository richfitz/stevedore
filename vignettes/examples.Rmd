...
We now have a redis server running on 32797
...
```
## E> 2018-03-27 14:57:36.577 UTC [67] ERROR:  column "Sepal.Length" of relation "mtcars" does not exist
## E> 2018-03-27 14:57:36.577 UTC [67] STATEMENT:  COPY "mtcars" ("Sepal.Length", "Sepal.Width", "Petal.Length", "Petal.Width", "Species") FROM STDIN
```
...
##  ---> Using cache
##  ---> 12fcbaa1b768
## Successfully built 12fcbaa1b768
...
```
## E> Cloning into '/tmp/tmp.zDDKoiJI3e'...
## O> * checking for file ‘/tmp/tmp.zDDKoiJI3e/DESCRIPTION’ ... OK
## O> * preparing ‘ids’:
...
## E>
## O> ────────────────────────────────────────────────────────────────────────────────
## O> ─  using log directory ‘/tmp/RtmpgnGIlw/file3f27848356/ids.Rcheck’
